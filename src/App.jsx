...
const PORT_ARRIVAL_DOCS = [
  { name: "Abu Dhabi, United Arab Emirates", file: "Arrival into Abu Dhabi, United Arab Emirates.pdf" },
  { name: "Alesund, Norway", file: "Arrival into Alesund, Norway.pdf" },
  { name: "Amsterdam", file: "Arrival into Amsterdam.pdf" },
  { name: "Anchorage, Alaska — Crown Plaza (Seward)", file: "Arrival into Anchorage AK Seward - Crown Plaza.pdf" },
  { name: "Anchorage, Alaska — Fairfield Inn (Seward)", file: "Arrival into Anchorage AK Seward - Fairfield Inn.pdf" },
  { name: "Anchorage, Alaska — Motel 6 (Seward)", file: "Arrival into Anchorage AK Seward - Motel 6.pdf" },
  { name: "Anchorage, Alaska — Plaza SS Explorer (Seward)", file: "Arrival into Anchorage AK Seward-Plaza SS Explorer.pdf" },
  { name: "Anchorage, Alaska — Joining in Whittier", file: "Arrival into Anchorage, Alaska - Joining in Whittier Alaska.pdf" },
  { name: "Auckland, New Zealand — Heartland Hotel", file: "Arrival into Auckland New Zealand, Heartland Hotel.pdf" },
  { name: "Baltimore — Officers and Crew", file: "Arrival into Baltimore - Officers and Crew.pdf" },
  { name: "Barcelona, Spain — Innside by Melia", file: "Arrival into Barcelona, Spain - Innside by Melia Barcelona Aeropuerto.pdf" },
  { name: "Benoa (Bali), Indonesia", file: "Arrival into Benoa (Bali), Indonesia.pdf" },
  { name: "Bergen, Norway", file: "Arrival into Bergen Norway.pdf" },
  { name: "Bermuda", file: "Arrival into Bermuda.pdf" },
  { name: "Bilbao, Spain", file: "Arrival into Bilbao, Spain.pdf" },
  { name: "Bodrum, Turkey", file: "Arrival into Bodrum, Turkey.pdf" },
  { name: "Bordeaux, France", file: "Arrival into Bordeaux, France.pdf" },
  { name: "Boston — JWL & BWY", file: "Arrival into Boston JWL & BWY.pdf" },
  { name: "Boston — Officers and Crew", file: "Arrival into Boston Officers and Crew.pdf" },
  { name: "Bremen — N. Joy", file: "Arrival into Bremen - N. Joy.pdf" },
  { name: "Brest, France (Dry Dock)", file: "Arrival into Brest, France (Dry Dock).pdf" },
  { name: "Bridgetown, Barbados", file: "Arrival into Bridgetown Barbados.pdf" },
  { name: "Brisbane, Australia", file: "Arrival into Brisbane, Australia.pdf" },
  { name: "Buenos Aires, Argentina", file: "Arrival into Buenos Aires, Argentina.pdf" },
  { name: "Busan, South Korea", file: "Arrival into Busan South Korea.pdf" },
  { name: "Cadiz, Spain", file: "Arrival into Cadiz, Spain.pdf" },
  { name: "Cairns, Australia", file: "Arrival into Cairns, Australia.pdf" },
  { name: "Callao, Peru", file: "Arrival into Callao, Peru.pdf" },
  { name: "Cannes, France", file: "Arrival into Cannes, France.pdf" },
  { name: "Cape Town, South Africa", file: "Arrival into Cape Town, South Africa.pdf" },
  { name: "Cartagena, Colombia", file: "Arrival into Cartagena, Colombia.pdf" },
  { name: "Civitavecchia, Italy — Holiday Inn Rome EUR (2026)", file: "Arrival into Civitavecchia Italy  - HOLIDAY INN ROME EUR PARCO DEI MEDICI- Effective April 16 2026.pdf" },
  { name: "Cobh, Ireland — Hotel Cork", file: "Arrival into Cobh Ireland for Hotel Cork.pdf" },
  { name: "Cobh, Ireland — Hotel Dublin", file: "Arrival into Cobh Ireland for Hotel Dublin.pdf" },
  { name: "Colon, Panama", file: "Arrival into Colon, Panama.pdf" },
  { name: "Copenhagen — Officers and Crew", file: "Arrival into Copenhagen - Officers and Crew.pdf" },
  { name: "Darwin, Australia", file: "Arrival into Darwin, Australia.pdf" },
  { name: "Doha, Qatar", file: "Arrival into Doha, Qatar.pdf" },
  { name: "Dubai, UAE", file: "Arrival into Dubai.pdf" },
  { name: "Dublin, Ireland", file: "Arrival into Dublin, Ireland.pdf" },
  { name: "Dubrovnik — Officers and Crew", file: "Arrival into Dubrovnik - Officers and Crew..pdf" },
  { name: "Durban, South Africa", file: "Arrival into Durban, South Africa.pdf" },
  { name: "Dry Dock — Southampton", file: "Dry Dock - Southampton.pdf" },
  { name: "Galveston, Texas (2026)", file: "Arrival into Galveston, Texas  2026.pdf" },
  { name: "Gibraltar", file: "Arrival into Gibraltar.pdf" },
  { name: "Haifa, Israel", file: "Arrival into Haifa, Israel.pdf" },
  { name: "Hamburg, Germany", file: "Arrival into Hamburg, Germany.pdf" },
  { name: "Helsinki, Finland", file: "Arrival into Helsinki, Finland.pdf" },
  { name: "Hilo, Hawaii", file: "Arrival into Hilo Hawaii  - Upd 7.21.pdf" },
  { name: "Hong Kong — Regala Skycity Hotel", file: "Arrival into Hong Kong, China -  Regala Skycity Hotel.pdf" },
  { name: "Honolulu — Best Western Plaza Hotel", file: "Arrival into Honolulu - Best Western Plaza Hotel - Upd7.21.pdf" },
  { name: "Honolulu — Officers (Ala Moana Hotel)", file: "Arrival into Honolulu - Officers (Ala Moana Hotel).pdf" },
  { name: "Honolulu — Officers (Aston)", file: "Arrival into Honolulu Hawaii -Officers (Aston)  - UPDATE 1.27.26.pdf" },
  { name: "Honolulu — Officers (Luxury Suites)", file: "Arrival into Honolulu - Officers (Luxury Suites) - Upd 7.21.pdf" },
  { name: "Honolulu — The Ambassador Hotel of Waikiki", file: "Arrival into Honolulu - The Ambassador Hotel of Waikiki Tapestry Collection by Hilton - Upd 7.21.pdf" },
  { name: "Houston — Officers & Crew", file: "Arrival into Houston - Officers & Crew.pdf" },
  { name: "Ijmuiden, Netherlands", file: "Arrival into Ijmuiden, Netherlands.pdf" },
  { name: "Incheon, South Korea", file: "Arrival into Incheon, South Korea.pdf" },
  { name: "Invergordon, United Kingdom", file: "Arrival into Invergordon, United Kingdom.pdf" },
  { name: "Istanbul, Turkey", file: "Arrival into Istanbul, Turkey.pdf" },
  { name: "Jacksonville, Florida", file: "Arrival into Jacksonville, Florida.pdf" },
  { name: "Juneau, Alaska", file: "Arrival into Juneau, Alaska.pdf" },
  { name: "Keelung, Taiwan", file: "Arrival into Keelung, Taiwan.pdf" },
  { name: "Ketchikan, Alaska — Officers & Crew", file: "Arrival into Ketchikan Alaska - Officers  Crew.pdf" },
  { name: "Kiel, Germany", file: "Arrival into Kiel, Germany.pdf" },
  { name: "Kotor, Montenegro", file: "Arrival into Kotor, Montenegro.pdf" },
  { name: "Kristiansund, Norway", file: "Arrival into Kristiansund, Norway.pdf" },
  { name: "Kusadasi, Turkey", file: "Arrival into Kusadasi - Turkey.pdf" },
  { name: "La Romana, Dominican Republic", file: "Arrival into La Romana, Dominican Republic.pdf" },
  { name: "Laem Chabang, Thailand", file: "Arrival into Laem Chabang, Thailand.pdf" },
  { name: "Las Palmas, Spain", file: "Arrival into Las Palmas, Spain.pdf" },
  { name: "Lautoka, Fiji", file: "Arrival into Lautoka, Fiji.pdf" },
  { name: "Le Havre, France", file: "Arrival into Le  Havre, France.pdf" },
  { name: "Le Havre, France (Updated March 2026)", file: "Arrival into Le Havre France - upd 3.2.26.pdf" },
  { name: "Le Havre, France (Dry Dock)", file: "Arrival into Le Havre, France (Dry Dock).pdf" },
  { name: "Limassol, Cyprus", file: "Arrival into Limassol, Cyprus.pdf" },
  { name: "Lisbon, Portugal", file: "Arrival into Lisbon, Portugal.pdf" },
  { name: "Livorno, Italy", file: "Arrival into Livorno, Italy.pdf" },
  { name: "Los Angeles (2026)", file: "Arrival into Los Angeles - 2026.pdf" },
  { name: "Manila, Philippines", file: "Arrival into Manila,Philippines.pdf" },
  { name: "Marseille, France", file: "Arrival into Marseille France.pdf" },
  { name: "Marseille, France (Dry Dock)", file: "Arrival into Marseille, France (Dry Dock).pdf" },
  { name: "Melbourne, Australia", file: "Arrival into Melbourne, Australia.pdf" },
  { name: "Messina, Italy", file: "Arrival into Messina, Italy.pdf" },
  { name: "Miami (2026)", file: "Arrival into Miami 2026 - Upd 1.26.26.pdf" },
  { name: "Monte Carlo, Monaco", file: "Arrival into Monte Carlo, Monaco.pdf" },
  { name: "Montevideo, Uruguay", file: "Arrival into Montevideo, Uruguay.pdf" },
  { name: "Montreal, Canada", file: "Arrival into Montreal, Canada.pdf" },
  { name: "Mumbai, India", file: "Arrival into Mumbai, India.pdf" },
  { name: "Naha, Japan", file: "Arrival into Naha, Japan.pdf" },
  { name: "Naples, Italy", file: "Arrival into Naples, Italy.pdf" },
  { name: "New Orleans — Officers and Crew", file: "Arrival into New Orleans - Officers and Crew.pdf" },
  { name: "New York", file: "Arrival into New York.pdf" },
  { name: "Ocho Rios, Jamaica", file: "Arrival into Ocho Rios, Jamaica.pdf" },
  { name: "Oranjestad, Aruba", file: "Arrival Into Oranjestad, Aruba.pdf" },
  { name: "Osaka, Japan", file: "Arrival into Osaka, Japan.pdf" },
  { name: "Oslo, Norway", file: "Arrival into Oslo, Norway.pdf" },
  { name: "Panama City, Panama", file: "Arrival into Panama City, Panama.pdf" },
  { name: "Papeete, French Polynesia", file: "Arrival into Papeete, French Polynesia.pdf" },
  { name: "Philadelphia, Pennsylvania", file: "Arrival into Philadelphia, Pennsylvania.pdf" },
  { name: "Philipsburg, St. Maarten", file: "Arrival into Philipsburg, St. Maarten.pdf" },
  { name: "Piraeus, Greece", file: "Arrival into Piraeus, Greece.pdf" },
  { name: "Ponta Delgada, Portugal", file: "Arrival into Ponta Delgada, Portugal.pdf" },
  { name: "Port Canaveral — Orlando, FL", file: "Arrival into Port Canaveral - Orlando, FL.pdf" },
  { name: "Port Elizabeth, South Africa", file: "Arrival into Port Elizabeth South Africa.pdf" },
  { name: "Port Klang, Malaysia", file: "Arrival into Port Klang, Malaysia.pdf" },
  { name: "Port Louis, Mauritius", file: "Arrival into Port Louis, Mauritius.pdf" },
  { name: "Puerto Madryn, Argentina", file: "Arrival into Puerto Madryn, Argentina.pdf" },
  { name: "Puntarenas, Costa Rica", file: "Arrival into Puntarenas, Costa Rica.pdf" },
  { name: "Quebec City, Canada", file: "Arrival into Quebec City.pdf" },
  { name: "Ravenna, Italy", file: "Arrival into Ravenna, Italy.pdf" },
  { name: "Reykjavik, Iceland", file: "Arrival into Reykjavik, Iceland.pdf" },
  { name: "Reykjavik, Iceland — Prima Crew", file: "Arrival into Reykjavik, Iceland - PRIMA CREW.pdf" },
  { name: "Rio de Janeiro, Brazil", file: "Arrival into Rio de Janeiro Brazil.pdf" },
  { name: "Roatan, Honduras", file: "Arrival into Roatan, Honduras.pdf" },
  { name: "Rotterdam, Netherlands", file: "Arrival into Rotterdam, Netherlands.pdf" },
  { name: "San Antonio, Chile", file: "Arrival into San Antonio, Chile.pdf" },
  { name: "San Diego — The Little Italy Hotel", file: "Arrival into San Diego - The Little Italy Hotel in Downtown San Diego.pdf" },
  { name: "San Juan, Puerto Rico — Viva", file: "Arrival into San Juan Puerto Rico, VIVA.pdf" },
  { name: "San Juan, Puerto Rico", file: "Arrival into San Juan, PR.pdf" },
  { name: "Seattle, Washington", file: "Arrival Letter into Seattle, Washington.pdf" },
  { name: "Shanghai, China", file: "Arrival into Shanghai, China.pdf" },
  { name: "Singapore", file: "Arrival into Singapore.pdf" },
  { name: "Siracusa, Italy", file: "Arrival into Siracusa, Italy.pdf" },
  { name: "Southampton, UK — Hilton Heathrow Terminal 4", file: "Arrival into Southampton, UK - HIlton London Heathrow Airport Terminal 4 Hotel.pdf" },
  { name: "Split — Officers & Crew", file: "Arrival into Split - Officers & Crew.pdf" },
  { name: "St. John's, Antigua and Barbuda", file: "Arrival into St John's Antigua and Barbuda.pdf" },
  { name: "St. Thomas, USVI", file: "Arrival into St. Thomas, USVI.pdf" },
  { name: "Stockholm, Sweden", file: "Arrival into Stockholm, Sweden.pdf" },
  { name: "Sydney, Australia (2026)", file: "Arrival into Sydney Australia 2026.pdf" },
  { name: "Tallinn, Estonia", file: "Arrival into Tallinn, Estonia.pdf" },
  { name: "Tampa — Officers and Crew", file: "Arrival into Tampa - Officers and Crew.pdf" },
  { name: "Tarragona, Spain", file: "Arrival into Tarragona, Spain.pdf" },
  { name: "Tianjin, China", file: "Arrival into Tianjin, China.pdf" },
  { name: "Tilbury, United Kingdom", file: "Arrival into Tilbury, United Kingdom.pdf" },
  { name: "Tokyo, Japan", file: "Arrival into Tokyo, Japan.pdf" },
  { name: "Trieste, Italy", file: "Arrival into Trieste, Itally.pdf" },
  { name: "Tromso, Norway", file: "Arrival into Tromso, Norway.pdf" },
  { name: "Valencia, Spain", file: "Arrival into Valencia, Spain.pdf" },
  { name: "Valletta, Malta", file: "Arrival into Valleta, Malta.pdf" },
  { name: "Valparaiso, Chile", file: "Arrival into Valparaiso, Chile.pdf" },
  { name: "Vancouver — Officers & Crew", file: "Arrival into Vancouver - Officers & Crew.pdf" },
  { name: "Venice, Italy", file: "Arrival into Venice, Italy.pdf" },
  { name: "Venice, Italy — Luna", file: "Arrival into Venice, Italy - LUNA.pdf" },
  { name: "Venice, Italy — Luna Newbuild", file: "Arrival into Venice, Italy - Luna Newbuild.pdf" },
  { name: "Victoria, Canada (Dry Dock)", file: "Arrival into Victoria, Canada (Dry Dock).pdf" },
  { name: "Willemstad, Curacao", file: "Arrival into Willemstad, Curacao.pdf" },
  { name: "Yokohama, Japan", file: "Arrival into Yokohama, Japan.pdf" },
  { name: "Zeebrugge, Belgium", file: "Arrival into Zeebrugge, Belgium.pdf" },
...
function PortArrivalPage({ onBack }) {
  ...
  const SITE = "https://nclcrewportal.netlify.app";

  function getFileUrl(file) {
    return SITE + "/arrival-docs/" + encodeURIComponent(file);
  }
  ...
  function getBadgeStyle() {
    return { background:"rgba(192,57,43,.1)", color:"var(--red)" };
  }
